...
export default function UpiPaymentSheet({ open, onClose, amount, restaurant, showTipAndRating = true, onPaymentDone }) {
  ...
  const handlePaySecurely = () => {
    if (baseAmount <= 0) { alert('Nothing to pay.'); return; }
      ...
      {open && (
        <>
          ...
          >
            ...
            >
              <style>{`#upi-pay-scroll-inner::-webkit-scrollbar { display: none; }`}</style>
              <div id="upi-pay-scroll-inner">
                ...
                >
                  ...
                  <div className="text-center relative z-10">
                    ...
                    <p className="text-white/70 text-[11px] mt-0.5">Complete your payment</p>
                  </div>
                </div>
                ...
                <div className="px-3 -mt-5 relative z-10 pb-4 space-y-3">
                  ...
                  {/* Fixed amount display (not editable — comes from your locked order total) */}
                  <div className="bg-card border border-border rounded-2xl p-4 shadow-sm">
                    <p className="text-center text-[11px] font-semibold text-muted-foreground uppercase tracking-wider mb-1">
                      Amount to Pay
                    </p>
